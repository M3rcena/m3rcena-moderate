...
const functions_1 = require("../../libs/functions.js");
const OptionChecking_1 = require("../../libs/OptionChecking.js");
const Kick = async (options) => {
    // Check type
    (0, OptionChecking_1.OptionsChecking)(options, "Kick");
    let interaction = options.interaction;
    if (!interaction)
        throw new Error(chalk_1.default.red("[@m3rcena/moderate] Kick Error:") + " No interaction provided.");
    let client = options.client;
    if (!interaction.channel)
        throw new Error(chalk_1.default.red("[@m3rcena/weky] Kick Error:") + " No channel found on Interaction.");
    if (!interaction.channel.isSendable())
        throw new Error(chalk_1.default.red("[@m3rcena/weky] Kick Error:") + " Channel is not sendable.");
    if (!interaction.guild)
        throw new Error(chalk_1.default.red("[@m3rcena/weky] Kick Error:") + " No guild found on Interaction.");
    try {
        ...
        throw new Error(chalk_1.default.red("[@m3rcena/weky] Kick Error:") + " " + error);
        return;
    }
    (0, functions_1.checkPackageUpdates)("Kick", options.notifyUpdate);
};
